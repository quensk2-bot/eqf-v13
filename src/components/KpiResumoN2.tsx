// src/components/KpiResumoN2.tsx
...
export function KpiResumoN2({ perfil }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h2 style={{ marginTop: 0, marginBottom: 4, color: "#3b82f6" }}>
            KPI da regional – Execuções
          </h2>
          <p style={{ margin: 0, fontSize: 11, color: "#9ca3af" }}>
            Baseada em rotina_execucoes + rotinas (regional)
          </p>
        </div>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          <button
            ...
            style={{
              ...
              fontSize: 11,
              background:
                view === "hoje" ? "#3b82f6" : "rgba(15,23,42,0.9)",
          ...
          <button
            ...
            style={{
              ...
              fontSize: 11,
              background:
                view === "30d" ? "#3b82f6" : "rgba(15,23,42,0.9)",
        ...
        <>
          ...
          >
            ...
            <KpiBox
              ...
              valor={resumoAtual.uniqExec.toString()}
            />
          </div>
