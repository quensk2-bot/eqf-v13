...
const adminStyles: Record<string, React.CSSProperties> = {
  ...
  tabActive: {
    background: `linear-gradient(90deg, ${theme.colors.neon}, ${theme.colors.orangeSoft})`,
...
export default function AdminPage() {
  ...
  // ---------- ESTRUTURA: DEPARTAMENTOS / SETORES / REGIONAIS ----------
  ...
  async function carregarEstrutura() {
    ...
    const [depRes, setRes, regRes] = await Promise.all([
      supabase.from("departamentos").select("id, nome, codigo, ativo").order("nome"),
      supabase
        .from("setores")
  ...
  async function salvarUsuario(e: React.FormEvent) {
    ...
    if (!usuarioSelecionado) {
      alert("Selecione um usuário na lista para editar.");
      return;
    }
    ...
    const payload = {
      ...
      departamento_id:
        formUsuario.departamento_id === "" ? null : Number(formUsuario.departamento_id),
      setor_id: formUsuario.setor_id === "" ? null : Number(formUsuario.setor_id),
      regional_id: formUsuario.regional_id === "" ? null : Number(formUsuario.regional_id),
    ...
    const atualizado = usuarios.find((u) => u.id === usuarioSelecionado.id) ?? null;
    if (atualizado) {
  ...
  async function salvarSetor(e: React.FormEvent) {
    ...
    if (editSetorId) {
      const { error } = await supabase.from("setores").update(payload).eq("id", editSetorId);
      if (error) {
  ...
  return (
    <div style={adminStyles.container}>
      ...
      <header style={adminStyles.header}>
        <h1 style={adminStyles.title}>Administração</h1>
        <p style={adminStyles.subtitle}>
          Cadastro e gestão de usuários e estrutura (departamentos, setores e
          regionais)
        </p>
      </header>
          ...
          <div style={adminStyles.card}>
            <div style={adminStyles.cardHeaderRow}>
              <h2 style={adminStyles.cardTitle}>
                {usuarioSelecionado ? "Editar usuário" : "Selecione um usuário"}
              </h2>
              <span style={adminStyles.badge}>
                Ajuste de nível, estrutura e status
              </span>
            </div>
              ...
              <form onSubmit={salvarUsuario}>
                <div style={adminStyles.formGrid}>
                  <div style={adminStyles.formGroup}>
                    ...
                    <div style={{ ...adminStyles.input, borderStyle: "dashed" }}>
        ...
        <section style={adminStyles.section}>
          ...
          <div style={adminStyles.card}>
            ...
            <form onSubmit={salvarDep}>
              <div style={adminStyles.formGrid}>
                <div style={adminStyles.formGroup}>
                  ...
                  <input
                    ...
                    value={formDep.nome}
                    onChange={(e) =>
                      setFormDep((prev) => ({ ...prev, nome: e.target.value }))
                    }
                ...
                <div style={adminStyles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormDep((prev) => ({ ...prev, codigo: e.target.value }))
                    }
                    style={adminStyles.input}
                  />
                </div>
              ...
              <div style={adminStyles.formActions}>
                <button type="submit" style={adminStyles.btnPrimary}>
                  {editDepId ? "Salvar departamento" : "Cadastrar departamento"}
                </button>
                {editDepId && (
                  <button
                    type="button"
          ...
          <div style={adminStyles.card}>
            <div style={adminStyles.cardHeaderRow}>
              <h2 style={adminStyles.cardTitle}>Setores ({setores.length})</h2>
            </div>
              ...
              <div style={adminStyles.formGrid}>
                ...
                <div style={adminStyles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormSetor((prev) => ({ ...prev, nome: e.target.value }))
                    }
                    style={adminStyles.input}
                  />
                </div>
              ...
              <div style={adminStyles.formGrid}>
                ...
                <div style={adminStyles.formGroup}>
                  ...
                  <input
                    ...
                    value={formReg.nome}
                    onChange={(e) =>
                      setFormReg((prev) => ({ ...prev, nome: e.target.value }))
                    }
                    style={adminStyles.input}
                  />
                </div>
        ...
        <section style={adminStyles.section}>
          <div style={adminStyles.card}>
            ...
            <p style={{ fontSize: 13, color: theme.colors.textMuted }}>
              ...
              <code>nivel</code> da tabela <code>usuarios</code> (ADM, N1, N2,
              N3, N0, N99). Futuramente podemos criar aqui uma tela para
